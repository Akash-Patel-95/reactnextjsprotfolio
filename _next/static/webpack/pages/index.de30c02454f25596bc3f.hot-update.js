...
})(["color:rgba(255,255,255,0.5);min-width:280px;letter-spacing:0.02em;font-size:20px;line-height:30px;padding:1rem;@media ", "{font-size:16px;line-height:28px;}@media ", "{line-height:22px;font-size:104px;min-width:100px;}"], function (props) {
  return props.theme.breakpoints.md;
}, function (props) {
  return props.theme.breakpoints.sm;
});
