...
})(["grid-area:1 / 2 / 2 / 4;display:flex;justify-content:space-;@media ", "{grid-area:2 / 2 / 3 / 5;}"], function (props) {
  return props.theme.breakpoints.sm;
});
